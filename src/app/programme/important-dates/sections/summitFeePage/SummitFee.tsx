import { InternationalFees, LocalFees } from "./data_fee";
...
export default function SummitFee() {
  return (
    <section id="summit-fee" className="scroll-mt-8">
      <h2 className="heading-2 text-secondary mb-2">Summit Fee</h2>

      {/* ================= INFORMATION ================= */}
      {/* <p className="mb-4">This conference publication was organized in collaboration with the School of Postgraduate Studies Universitas Pendidikan Indonesia (UPI).</p> */}

      {/* ================= INTERNATIONAL FEES ================= */}
      <h3 className="heading-3 text-primary mb-4">International Category</h3>
      ...
      {/* ================= LOCAL FEES ================= */}
      <h3 className="heading-3 text-primary mb-4">Local Category</h3>
      ...
      <p className="text-small text-gray-600 mt-4">
        This conference publication was organized in collaboration with the School of Postgraduate Studies Universitas Pendidikan Indonesia.
      </p>
    </section>
  );
}
