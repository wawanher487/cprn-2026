...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className=" md:mx-20  px-4 md:px-8 overflow-hidden scroll-mt-15"
    >
      <div className="mx-auto bg-primary max-w-7xl border border-border rounded-xl text-white py-10">
        ...
        >
          {testimonialsData.map((testi, i) => (
            <div
              key={i}
              className="min-w-full text-center flex flex-col gap-4 px-10"
            >
              <span>
