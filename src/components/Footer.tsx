        ...
        <div className="mx-auto max-w-7xl px-6 py-14">
            ...
            <div className="grid gap-10 md:grid-cols-4">
                ...
                <div>
                    ...
                    <ul className="mt-4 space-y-2 text-small text-text-muted">
                        <li><Link href="/" className="hover:text-primary">Programmes</Link></li>
                        <li><Link href="/" className="hover:text-primary">Important Dates</Link></li>
                        <li><Link href="/" className="hover:text-primary">Concept Notes</Link></li>
                        <li><Link href="/" className="hover:text-primary">Summit Fee</Link></li>
                    </ul>
                </div>
